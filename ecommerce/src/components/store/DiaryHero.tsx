...
const SparkleEffect = ({ delay, top, left, size }: { delay: number, top: string, left: string, size: number }) => (
  <motion.div
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute overflow-hidden inset-0">
          <div className="absolute top-[70%] md:top-1/2 right-1/2 md:right-[20%] translate-x-1/2 md:translate-x-0 -translate-y-1/2 w-[400px] h-[400px] rounded-full border border-white/10" style={{ animation: 'ambient-drift 15s infinite' }} />
          <div className="absolute top-[70%] md:top-1/2 right-1/2 md:right-[20%] translate-x-1/2 md:translate-x-0 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-white/10 border-dashed" style={{ animation: 'spin-slow 40s linear infinite' }} />
        </div>
            ...
            >
              ...
              <div className="overflow-hidden pt-2 md:pt-4">
                ...
                >
                  ...
                  >
                    ...
                    <span className="relative z-10">{banner.buttonText || "Acheter"}</span>
              ...
              >
                <div className="flex flex-col items-center justify-center text-center gap-0.5 md:gap-1">
                  <Target className="w-3.5 h-3.5 md:w-4 md:h-4 text-emerald-500" style={{ color: "var(--store-primary)" }} strokeWidth={2.5} />
                  <span className={`${outfit.className} text-sm md:text-base font-black text-[#1A1A24] leading-none tracking-tight`}>4.9</span>
                  <span className="text-[5px] md:text-[6px] font-bold uppercase tracking-[0.2em] text-[#6B7280]">Excellence</span>
                </div>
                
                <div className="w-px h-5 md:h-6 bg-slate-200/80" />
                
                <div className="flex flex-col items-center justify-center text-center gap-0.5 md:gap-1">
                  <TrendingUp className="w-3.5 h-3.5 md:w-4 md:h-4 text-emerald-500" style={{ color: "var(--store-primary)" }} strokeWidth={2.5} />
                  <span className={`${outfit.className} text-sm md:text-base font-black text-[#1A1A24] leading-none tracking-tight`}>+38%</span>
                  <span className="text-[5px] md:text-[6px] font-bold uppercase tracking-[0.2em] text-[#6B7280]">Tendance</span>
                </div>

                <div className="w-px h-5 md:h-6 bg-slate-200/80" />
                
                <div className="flex flex-col items-center justify-center text-center gap-0.5 md:gap-1">
                  <ShieldCheck className="w-3.5 h-3.5 md:w-4 md:h-4 text-emerald-500" style={{ color: "var(--store-primary)" }} strokeWidth={2.5} />
                  <span className={`${outfit.className} text-sm md:text-base font-black text-[#1A1A24] leading-none tracking-tight`}>30j</span>
                  <span className="text-[5px] md:text-[6px] font-bold uppercase tracking-[0.2em] text-[#6B7280]">Garantie</span>
                </div>
              </motion.div>
        ...
        <div className="w-full md:w-[50%] h-auto md:h-full relative flex items-center justify-center flex-1 order-2 md:order-2 mt-8 md:mt-0">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <motion.div 
                className="relative w-[280px] sm:w-[320px] md:w-[500px] h-[300px] sm:h-[350px] md:h-[480px] z-10"
              >
                <motion.div
                  animate={{ 
                    y: [0, -15, 0],
              ...
              >
                ...
                >
                  <div className="absolute inset-0 w-[200%] bg-gradient-to-r from-transparent via-white/20 to-transparent -skew-x-12" style={{ animation: "shimmer 3s infinite" }} />
                  <div className="relative z-10 flex -space-x-2">
                    {(recentCustomers?.length > 0 ? recentCustomers : [1, 2, 3]).slice(0, 3).map((c: any, i) => (
                      <div
              ...
              >
                ...
                >
                  ...
                  >
                    <span className={`${playfair.className} text-2xl md:text-3xl font-black italic tracking-tighter leading-none`}>
                      -50%
                    </span>
